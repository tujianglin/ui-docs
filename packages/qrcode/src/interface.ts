...
import type { CanvasHTMLAttributes, SVGAttributes } from 'vue-jsx-vapor';
...
export type QRPropsCanvas = QRProps & Omit<CanvasHTMLAttributes<HTMLCanvasElement>, 'style'>;

export type QRPropsSVG = QRProps & Omit<SVGAttributes, 'style'>;
