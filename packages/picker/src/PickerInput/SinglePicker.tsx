...
export interface PickerProps extends BasePickerProps, Omit<SharedTimeProps, 'format' | 'defaultValue'> {}
...
function Picker(props: PickerProps, ref: React.Ref<PickerRef>) {
  // ========================= Prop =========================
  ...
  const triggerModeChange = useEvent((nextPickerValue: DateType, nextMode: PanelMode, triggerEvent?: boolean) => {
    ...
    if (onPanelChange && triggerEvent !== false) {
      const lastPickerValue: DateType = nextPickerValue || calendarValue[calendarValue.length - 1];
...
const RefPicker = React.forwardRef(Picker) as (props: PickerProps & React.RefAttributes<PickerRef>) => React.ReactElement;
