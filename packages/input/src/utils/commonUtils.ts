import type { ChangeEvent, CompositionEvent, MouseEvent, SyntheticEvent } from 'vue-jsx-vapor';
...
function cloneEvent<EventType extends SyntheticEvent<any, any>, Element extends HTMLInputElement | HTMLTextAreaElement>(
  event: EventType,
  target: Element,
  value: any,
): EventType {
...
export function resolveOnChange<E extends HTMLInputElement | HTMLTextAreaElement>(
  target: E,
  e: ChangeEvent<E> | MouseEvent<HTMLElement, MouseEvent> | CompositionEvent<HTMLElement>,
