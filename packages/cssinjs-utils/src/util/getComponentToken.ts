import type { TokenType } from '@vc-com/cssinjs';
import { warning } from '@vc-com/util';
import type { ComponentToken, ComponentTokenKey, GlobalToken, TokenMap, TokenMapKey } from '../interface';

function getComponentToken<CompTokenMap extends TokenMap, AliasToken extends TokenType, C extends TokenMapKey<CompTokenMap>>(
  component: C,
